...
- **Construction logistics** — placing a production, storage, service, faith, or trade building creates a cleared construction site, automatically assigns up to four available builders, and reserves its timber/stone cost without teleporting stock. Staffed storehouses are preferred dispatch points, staffed producers are fallbacks, and recognizable timber/stone carts unload into the intended site. Builders can advance only as far as delivered materials allow; the founding treasury is a paced bootstrap reserve for the first supply chain.
...
- **Building storage** — the village storehouse centralizes timber, stone, and firewood; mills, lodges, quarries, wells, granaries, and processors retain specialized capped inventories. Construction spending protects reserved stock from trade and other orders until it is delivered or the site is cancelled.
