...
export const BUILDING_KINDS = ["lumber_mill","reforester","woodcutters_lodge","stone_quarry","well","hunters_hall","foragers_shed","chapel","marketplace","threshing_barn","monastery","brewery","smokehouse","granary","apiary","watermill","carpenter","ferry_landing","vineyard"] as const;
