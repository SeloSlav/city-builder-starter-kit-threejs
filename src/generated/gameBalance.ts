...
export const BUILDING_KINDS = ["lumber_mill","reforester","woodcutters_lodge","stone_quarry","well","hunters_hall","foragers_shed","chapel","marketplace","grain_field","threshing_barn","monastery","brewery","smokehouse","granary","apiary","watermill","carpenter","ferry_landing","vineyard"] as const;
...
export const BUILDING_STORAGE_CAPS = {
  ...
  grain_field: { timber: 0, firewood: 0, stone: 0, grain: 120 },
